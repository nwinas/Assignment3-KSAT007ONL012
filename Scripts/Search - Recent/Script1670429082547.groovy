...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Search'), 'baju', 0)

Mobile.getText(findTestObject('Object Repository/android.widget.EditText - baju'), 0)
